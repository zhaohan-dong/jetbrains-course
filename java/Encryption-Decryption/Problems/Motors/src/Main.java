...
class PneumaticMotor extends Motor {
    ...
    public PneumaticMotor(String model, long power) { super(model, power); }
...
class HydraulicMotor extends Motor {
    // write your code here ...
    public HydraulicMotor(String model, long power) { super(model, power); }
...
class ElectricMotor extends Motor {
    // write your code here ...
    public ElectricMotor(String model, long power) { super(model, power); }
...
class WarpDrive extends Motor {
    // write your code here ...
    public WarpDrive(String model, long power) { super(model, power); }

    @Override
    public String toString() { return "Warp drive " + super.toString(); }
}
...
class MotorFactory {
    ...
    public static Motor make(char type, String model, long power) {
        // write your code here ...
        type = java.lang.Character.toUpperCase(type);
